...
def _embeddings_enabled() -> bool:
    ...
    Embeddings are now generated by the standalone embedding service
    (see embedding_service/) rather than running SentenceTransformer in this
    process.  Both EMBEDDINGS_ENABLED=true AND a reachable EMBEDDING_SERVICE_URL
